<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      <!-- <rating-control v-model="rating" :model-value="" @update:model-value=""></rating-control> -->
...
<script>
import RatingControl from './RadtingControl.vue';
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(this.$refs.ageInput.value + 0);
      console.log(typeof 42 === typeof this.userAge);
